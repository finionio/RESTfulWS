package org.restfulws.utm.config;
...
@ComponentScan(
		basePackageClasses = {
			   		org.restfulws.utm.web.ComponentPackageMaker.class,
			   		org.restfulws.utm.repository.ComponentPackageMaker.class,
			   		org.restfulws.utm.service.ComponentPackageMaker.class,
			   		org.restfulws.utm.component.ComponentPackageMaker.class }, 
...
public class RootContextConfig implements AsyncConfigurer, SchedulingConfigurer {
	...
	public Jaxb2Marshaller jaxb2Marshaller() {
		...
		marshaller.setPackagesToScan(new String[] { "org.restfulws.utm.model" });
		return marshaller;
	}
	...
	public JavaMailSender javaMailSender() {
	    ...
	    mailSender.setUsername("fernandoga_13@hotmail.com");
	    mailSender.setPassword("finionio.91");
